...
import 'package:dictonary/widgets/mean_list.dart';
import 'package:dictonary/widgets/sign_language.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [const SizedBox(height: 10), Padding(
            padding: const EdgeInsets.all(8.0),
            child: Container(
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(25),color:Colors.red[50]),
              child: TextField(controller: _controller,
              decoration: InputDecoration(hintText: 'Güncel Türkçe Sözlük\'te Ara',
              suffixIcon: InkWell(
...
switch (vm.status.index) {
  ...
  case 1:
  return const Center(child: SizedBox(child: CircularProgressIndicator(),height: 50,width: 50,));
  case 2:
  return const Text('Herhangi bir sonuç bulunamadı',
  style: TextStyle(fontSize: 18),
  );
  default:
return MeanList(meaningViewModel: vm.meaningViewModel, signLanguage: SignLanguage(word: vm.meaningViewModel.word));
